<template>
  <div>
    ...
    <!-- card -->
    <div v-if="resolvedTickets.length != 0" class="md:flex md:gap-8 container mx-auto md:w-[90%]">
    
    <div class="bg-[#eeeff4] py-5">
    ...
    >
      ...
      <img src="public/download.png" alt="" style="height:70px;width:200px">
          ...
          <div class="bg-[#eeeff4] py-4 md:mt-[5%]">
          ...
          >
              ...
              >
                ...
                <div class="md:block hidden">
                  <div class="flex gap-6">
                    ...
                    <div class="w-24">
                      <button
                        v-if="selectedTicket.status.name == 'Awaiting Reply'"
                        @click="reOpen"
                        type="button"
                        class="w-full h-10 w-24 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg bg-blue-700 text-white hover:bg-[#2741b6] disabled:opacity-50 disabled:pointer-events-none"
                      >
            ...
            <div class="overflow-y-auto  pb-20">
              <div class="w-full p-4">
                ...
                <div class="md:block hidden mt-6">
                  <div
                    class="flex justify-center items-center  px-2 container md:md:w-[90%] md:mx-auto "   v-if="selectedTicket.status.name == 'Awaiting Reply'"
                  >
                  <div class="w-full ">
                     <button
                   style="width:100%"
                  ...
                  <div  class="flex justify-center items-center  px-2 container md:md:w-[90%] md:mx-auto " v-else > <div class="w-full ">
                     <button
                   style="width:100%"
                      @click="openRatings"
                      type="button"
            ...
            <!-- <div class="md:block hidden">
              <div
                class="flex justify-start items-center gap-x-2 py-3 px-4 bg-white mt-auto fixed bottom-0 z-10 w-full"
              >
                <button
                  style="width: 200px"
                  @click="openRatings"
...
export default {
  ...
  methods: {
    ...
    viewAttach(
      this: { openImageFile: boolean; apiImage: any; pdf: any; isPdf: boolean },
      data: any
    ) {
    ...
    resetHover(this: { hover: any; rating: any }) {
      this.hover = this.rating;
    },

    selectRating(
      this: { rating: any; ratingData: any; selectedTicket: any },
      star: number
    ) {
      ...
      const ratingRecord = {
        ...
        ticketNo: this.selectedTicket.number,
      };

      this.ratingData = ratingRecord;
      console.log(this.ratingData, "ratingData");
    },
    async postRatings(this: {
      load: boolean;
      ratingData: any;
      rating: any;
      ratingResponse: any;
      ...
      if (clientCode) formData.append("clientcode", clientCode);

      formData.append("ticket_no", this.ratingData?.ticketNo);
      formData.append("rating", this.rating);

      try {
        const response = await axios.post(
          "https://g1.gwcindia.in/ticket-api/add-rating.php",
          formData
        );
        this.ratingResponse = response.data;
        if (this.ratingResponse) {
          this.apirating = this.ratingResponse.rating;
        }
        console.log(this.apirating, "this.apirating");
      } catch (error) {
    ...
    async getTicketMessages(
      this: { selectedTicketsData: any; loader: boolean; rating: any },
      number: any
    ) {
      this.loader = true;
      const formData = new FormData();
